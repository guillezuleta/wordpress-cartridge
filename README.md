...
Create a php-5.4 application (you can call your application whatever you want)
    ...
    rhc app create wordpress php-5.4 mysql-5.5 phpmyadmin-4 --from-code=https://github.com/jazb/wordpress-cartridge
    
or
    rhc app create wordpress php-5.4 mysql-5.5 phpmyadmin-4
    
Add this upstream Wordpress repo

    cd wordpress
    git remote add upstream -m master git://github.com/jazb/wordpress-cartridge.git
